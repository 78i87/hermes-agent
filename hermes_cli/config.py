...
OPTIONAL_ENV_VARS = {
    ...
    "IOS_PET_ENABLED": {
        "description": "Enable the iOS pet companion HTTP server (pairing + SSE push; default port 8643).",
        "prompt": "Enable iOS pet adapter (true/false)",
        "url": None,
        "password": False,
        "category": "messaging",
        "advanced": True,
    ...
    "IOS_PET_ADMIN_KEY": {
        "description": "Bearer token for admin endpoints (pair/start, devices, test_push). Falls back to API_SERVER_KEY if unset. Required for non-loopback bind.",
        "prompt": "iOS pet admin key",
        "url": None,
        "password": True,
        "category": "messaging",
        "advanced": True,
    ...
    "IOS_PET_PORT": {
        "description": "Port for the iOS pet HTTP server (default: 8643).",
        "prompt": "iOS pet port",
        "url": None,
        "password": False,
        "category": "messaging",
    ...
    "IOS_PET_HOST": {
        "description": "Host/bind address for the iOS pet server (default: 127.0.0.1). Use 0.0.0.0 for LAN access — requires IOS_PET_ADMIN_KEY or API_SERVER_KEY.",
        "prompt": "iOS pet host",
        "url": None,
        "password": False,
        "category": "messaging",
    ...
    "IOS_PET_HOME_CHANNEL": {
        "description": "Default device UUID for send_message target 'ios_pet' without a suffix (home channel).",
        "prompt": "iOS pet home device id",
        "url": None,
        "password": False,
        "category": "messaging",
        "advanced": True,
    },
    "IOS_PET_HOME_CHANNEL_NAME": {
        "description": "Display name for the iOS pet home channel in listings.",
        "prompt": "iOS pet home channel name",
        "url": None,
        "password": False,
        "category": "messaging",
        "advanced": True,
    },
    "IOS_PET_ALLOWED_DEVICES": {
        "description": "Comma-separated device UUIDs allowed to use gateway-authorized iOS pet flows (when used).",
        "prompt": "iOS pet allowed devices",
        "url": None,
        "password": False,
        "category": "messaging",
        "advanced": True,
    },
    "IOS_PET_ALLOW_ALL_DEVICES": {
        "description": "Allow all iOS pet devices without an allowlist (true/false).",
        "prompt": "iOS pet allow all devices",
        "url": None,
        "password": False,
        "category": "messaging",
        "advanced": True,
